...
import unicodedata
from appointments.models import Cliente, Servico, Profissional, Agendamento
...
class Command(BaseCommand):
    ...
    def formatar_nome_para_email(self, nome):
        ...
        email_user = ''.join(c if c.isalnum() or c == '.' else '.' for c in nome_normalizado.lower().replace(' ', '.'))
    ...
    def handle(self, *args, **options):
        ...
        for prof_data in profissionais_data:
            ...
            if created:
                ...
                servicos_especialidade = [s for s in servicos if s.categoria in especialidades]
            ...
            for _ in range(num_agendamentos):
                ...
                if servicos_prof:
                    ...
                    if dias_atras > 7:
                        ...
                        status = random.choice(['CONCLUIDO', 'CANCELADO', 'NAO_COMPARECEU'])
        ...
        for dias_futuro in range(0, 15):
            ...
            profissionais_trabalham = [
                ...
                if str(dia_semana) in p.lista_dias_semana
            ]
                ...
                for _ in range(num_agendamentos):
                    ...
                    if servicos_prof:
                        ...
                        if dias_futuro == 0:  # Hoje
                            status = random.choice(['AGENDADO', 'CONFIRMADO', 'EM_ANDAMENTO'])
                        else:
