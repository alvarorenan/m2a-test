...
urlpatterns = [
    ...
    path('agendamentos/<int:pk>/editar/', views.AgendamentoUpdateView.as_view(), name='agendamento_edit'),
    path('agendamentos/<int:pk>/status/', views.atualizar_status_agendamento, name='atualizar_status'),
    ...
    # Profissionais
    path('profissionais/', views.ProfissionalListView.as_view(), name='profissional_list'),
    path('profissionais/novo/', views.ProfissionalCreateView.as_view(), name='profissional_create'),
    path('profissionais/<int:pk>/editar/', views.ProfissionalUpdateView.as_view(), name='profissional_update'),
